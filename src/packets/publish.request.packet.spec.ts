...
describe('PublishRequestPacket', function () {
  describe('writePublishRequestPacket', function () {
    it('should write a minimal packet', function () {
      assertWritePacket(
        writePublishRequestPacket,
        {
          topic: 'A',
        },
        { flags: 0, identifier: undefined },
        '0001',
        '41',
      );
    });
    ...
    it('should support DUP', function () {
      assertWritePacket(
        ...
        { flags: 0b1000, identifier: undefined },
        '0001',
        '41',
      );
    });
    it('should support RETAIN', function () {
      assertWritePacket(
        ...
        { flags: 0b0001, identifier: undefined },
        '0001',
        '41',
      );
    });
    it('should support DUP QoS and RETAIN together', function () {
      ...
      assertWritePacket(
        ...
        { flags: 0b1001, identifier: undefined },
        '0001',
        '41',
      );
    });
    it('should throw on QoS > 2', function () {
      assert.throws(() =>
        writePublishRequestPacket(PacketStream.empty(), {
          topic: 'A',
          qos: 3,
        }),
      );
