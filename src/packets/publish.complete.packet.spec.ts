...
import { PublishCompletePacket, readPublishCompletePacket, writePublishCompletePacket } from './publish.complete.packet';

describe('PublishCompletePacket', function () {
    describe('readPublishCompletePacket', function () {
        it('should read properly', function () {
            assertPacket(readPublishCompletePacket(PacketStream.fromHex('000a'), 2), PublishCompletePacket, new PublishCompletePacket(10));
        });
